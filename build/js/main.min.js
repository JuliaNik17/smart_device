...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var modalCloseButton = document.querySelector('.modal__close-btn'); // const focusTrap = createFocusTrap('#modal', {
  ...
  var modalClosed = function modalClosed() {
    modal.classList.remove('is-active');
    body.classList.remove('page__lock');
    document.removeEventListener('keydown', onModalEscKeydown); // focusTrap.deactivate();
  };
  ...
  Object(_modules_modals_init_modals__WEBPACK_IMPORTED_MODULE_1__["initModals"])(); // Modules
  // ---------------------------------
  ...
  (function () {
    ...
    pageHeaderButton.addEventListener('click', function () {
      ...
      Object(_modules_modals_init_modals__WEBPACK_IMPORTED_MODULE_1__["initModals"])(); // focusTrap.activate();
    });
