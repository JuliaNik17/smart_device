...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var accordeonHeadNav = document.querySelector('.accordeon__head--nav');
  var accordeonHeadContacts = document.querySelector('.accordeon__head--contacts');
  IMask(phoneNumberModal, maskOptions); // Modules
  // ---------------------------------
