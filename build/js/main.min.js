...
var name = document.querySelector('.client-name-modal');

(function () {
  var inputFocused = name.focus();
  return inputFocused;
})();
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var pageHeaderButton = document.querySelector('.page-header__button'); // const form = document.querySelector('.contact-us form');
  ...
  var modalOverlay = document.querySelector('.modal__overlay'); // const modalFocusTrap = createFocusTrap('.modal');
  ...
  pageHeaderButton.addEventListener('click', function () {
    ...
    document.addEventListener('keydown', onModalEscKeydown); // modalFocusTrap.activate();
    // FocusLock(modal);
  ...
  modalCloseButton.addEventListener('click', function () {
    modal.classList.remove('is-active');
    body.classList.remove('page__lock'); // modalFocusTrap.deactivate();
