...
/* harmony import */ var _utils_focus_lock__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./utils/focus-lock */ "./js/utils/focus-lock.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var modalSendButton = document.querySelector('.send-button--modal');
  ...
  var aboutCompanyHidden = document.querySelector('.about-company__hidden');
  ...
  (function () {
    ...
    pageHeaderButton.addEventListener('click', function () {
      ...
      modalForm.FocusLock = new _utils_focus_lock__WEBPACK_IMPORTED_MODULE_2__["FocusLock"]();
