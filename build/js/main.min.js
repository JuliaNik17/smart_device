...
/* harmony import */ var _popup__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./popup */ "./js/popup.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var phoneNumberModal = document.querySelector('.phone-number-modal');
  IMask(phoneNumberModal, maskOptions); // все скрипты должны быть в обработчике 'DOMContentLoaded', но не все в 'load'
  ...
  var aboutCompanyHidden = document.querySelector('.about-company__hidden'); // const form = document.querySelector('.contact-us form');
...
var pageFooterNavButton = document.querySelector('.page-footer__nav button');
var pageFooterContactsButton = document.querySelector('.page-footer__contacts button');
var pageFooterNav = document.querySelector('.page-footer__nav');
...
/***/ "./js/modules/modals/focus-trap.js":
/*!*****************************************!*\
  !*** ./js/modules/modals/focus-trap.js ***!
  \*****************************************/
...
var tabbable = __webpack_require__(/*! tabbable */ "../node_modules/tabbable/dist/index.esm.js");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _modules_modals_focus_trap__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/modals/focus-trap */ "./js/modules/modals/focus-trap.js");
/* harmony import */ var _modules_modals_focus_trap__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_modules_modals_focus_trap__WEBPACK_IMPORTED_MODULE_0__);

var clientName = document.querySelector('.client-name-modal');
...
var modalCloseButton = document.querySelector('.modal__close-btn');
var modalFormFocusTrap = Object(_modules_modals_focus_trap__WEBPACK_IMPORTED_MODULE_0__["createFocusTrap"])('.modal form');
